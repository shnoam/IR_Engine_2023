...
REGION=us-central1
ZONE=us-central1-a
PROJECT_NAME="shamir-ilay-the-kings"
IP_NAME="$PROJECT_NAME-ip"
GOOGLE_ACCOUNT_NAME="shnoam" # without the @post.bgu.ac.il or @gmail.com part
...
gcloud compute instances create $INSTANCE_NAME \
  ...
  --metadata startup-script-url=https://storage.cloud.google.com/316139070_206204588/startup_script_gcp.sh \
